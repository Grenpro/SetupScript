...
echo 7. Mcafee and Cloud Automation
echo 8. SuperCleanerv5
echo 9. Adwcleaner
echo 10. Startscript
echo 11. Programs
echo 12. Multicleaner
echo.
...
for %%a in (%choices%) do (
    ...
    IF %%a==7 call start serverlogon.cmd
    IF %%a==8 call start SuperCleanerV5.cmd
    IF %%a==9 call start adwclean.cmd
    IF %%a==10 call start Startscript.cmd
    IF %%a==11 Programs.cmd
    IF %%a==12 call start ..\Multicleaner\Multiclean.cmd
)
